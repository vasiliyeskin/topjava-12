...
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/1211db65790e4aadbb235d3eeb5c10ea)](https://www.codacy.com/app/vasiliyeskin/topjava-12?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=vasiliyeskin/topjava-12&amp;utm_campaign=Badge_Grade)
...
- без 2х проходов в цикле по List<UserMeal>. Обратите внимание на п.13 замечаний
- через Stream API, которое может быть выражено одной строкой кода
```
